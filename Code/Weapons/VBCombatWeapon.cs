...
public sealed class VBCombatWeapon : BaseCombatWeapon, IVBWeaponCarryItem, IVBFirstPersonHeldItem
{
	/// <summary>
	...
	public float FirstPersonMotionAimAmount => _aimAmount;
	...
	/// <summary>
	/// Garantit le modèle 3PP sur chaque pair.
	/// </summary>
